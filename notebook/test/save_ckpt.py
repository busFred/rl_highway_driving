...
#%%
args = [
    "--env_config_path", "../../config/change_lane_d/env/02.json",
...
ckpt_path_fn = "../../model/epoch=8659-step=437733.ckpt"
export_path_fn = "../../model/env_02_dqn_04_ld_00_1.pt"
...
if __name__ == "__main__":
    ...
    dqn = alg_dqn.DQNTrain.load_from_checkpoint(ckpt_path_fn,
                                                ...
                                                optimizer=optim,
                                                is_just_load=True)
    torch.save(dqn.dqn, export_path_fn)